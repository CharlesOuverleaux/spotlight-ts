...
Read the full article: [TypeScript Type Transformation for Sanity CMS](https://metycle.com/articles/tech/typescript-type-transformation-for-sanity-cms)

Find the linkedin post: [TypeScript Type Transformation for Sanity CMS](https://www.linkedin.com/posts/metycle_circulareconomy-recyclingtech-secondarymetals-activity-7375793507531399168-uCVA?utm_source=share&utm_medium=member_desktop&rcm=ACoAAA3iaOcBsVxlevW5pSYUaa9ejSvkS4B4jGc)